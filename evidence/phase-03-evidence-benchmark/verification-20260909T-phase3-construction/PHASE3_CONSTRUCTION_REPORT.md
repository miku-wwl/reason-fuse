...
- Batch: `verification-20260909T-phase3-construction`
...
- Steps/run: `2.810000`.
- Containment latency p50/p95/p99 ms: `0.476650` / `1.064810` / `1.567361`.
...
- Events/second: `4776.313991`.
- Per-event latency p50/p95/p99 ns: `88600.000000` / `597225.000000` / `901316.000000`.
