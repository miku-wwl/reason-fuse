> Archived construction task. The `phase1-runtime-validation/` tree below is the
> original temporary layout. The active project layout is now defined by the
> [repository README](../../../README.md); all phases evolve that same root project.
